...
import interfaceAccountSettings from './controllers/interface-account-settings.controller';
...
OpenProjectStimulusApplication.preregister('interface-account-settings', interfaceAccountSettings);
