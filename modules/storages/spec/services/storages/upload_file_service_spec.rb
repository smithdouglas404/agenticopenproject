...
RSpec.describe Storages::UploadFileService, :vcr, :webmock, type: :model do
    ...
    context "when storage is Nextcloud" do
      context "when folder exists" do
        ...
        it "uploads and creates a FileLink via Nextcloud" do
          ...
          end.to change(Storages::FileLink, :count).by(1)
      ...
      context "when folder does not exist" do
        # ...existing code...
        it "creates the folder, uploads, and creates a FileLink" do
          expect do
