...
RSpec.describe Overviews::Widgets::ProjectStatusesController do
  ...
  describe "PUT #update" do
    ...
    context "with valid status_explanation param" do
      ...
      context "when service call succeeds" do
        ...
        it "renders turbo streams updating Overviews::Widgets::ProjectStatusComponent and flash action", :aggregate_failures do
          expect(response).to be_successful
          expect(assigns(:project)).to eq project
          expect(response).to have_turbo_stream action: "update", target: "overviews-widgets-project-status-component"
