    ...
    class SqlCollectionRepresenter
      ...
      class << self
        def ctes(walker_result)
          ...
          collection_selects = (walker_result.url_query[:select] || {}).keys
          if collection_selects.include?("total") || collection_selects.include?("nextByOffset") ||
              collection_selects.include?("*")
