...
| [OKR](okr-management)                                        | Use OpenProject to set strategic goals, break them down into measurable key results, and track progress in a transparent and aligned way.<br />Learn how to manage OKRs, establish relations between goals and results, and embed goal-setting into your project management flow. |
