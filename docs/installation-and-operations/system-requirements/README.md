...
The all-in-one container only will additionally install [hocuspocus](https://github.com/opf/op-blocknote-hocuspocus) which is required for the real-time collaboration feature in OpenProject.
## Client
