...
| [5 Initiating Phase](/5-initiatiing-phase)                   | Defines the activities needed to start a project. This includes preparing the Project Initiation Request (PIR), developing the Business Case, drafting the Project Charter, and obtaining formal approval through the Request for Planning (RfP) phase gate. |
