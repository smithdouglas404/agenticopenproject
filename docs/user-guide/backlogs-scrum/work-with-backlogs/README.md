...
![backlog_fullscreen_view](openproject_user_guide_backlogs_fullscreen_view.png)



With the **Move** menu, you can order items according to your preference.

![backlogs_move_menu](openproject_user_guide_backlog_ move_options.png)
...
![sprint_planning](openproject_user_guide_backlog_sprint_planning.png)
...
![start_sprint](openproject_user_guide_backlogs_start_sprint.png)



Your active sprint can be easily managed through the menu options. 

![sprint_menu_item](openproject_user_guide_backlog_sprint_menu _item.png)
...
![sprint_board](openproject_user_guide_backlogs_sprint_board.png)
