...
![User-guide-backlogs-manage-sprints](openproject_user_guide_backlogs_manage_sprints_menu_option.png)
...
![Select column location for OpenProject backlogs under project settings](openproject_user_guide_backlogs_manage_sprints_column_location.png)
