...
| [Tablet support](tablet-support) | The app is optimized not only for smartphones but also for tablet devices with a more spacious layout and improved navigation. |
